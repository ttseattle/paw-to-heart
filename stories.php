...
<html>
	...
	<body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                   <img class="stories-img" src="http://g-ecx.images-amazon.com/images/G/01/img15/pet-products/small-tiles/23695_pets_vertical_store_dogs_small_tile_8._CB312176604_.jpg" alt="Happy Dog" >
                </div>
                <div class="col-md-8">
                    <h2> Snowball </h2>
                    <p>
            ...
            <div class="row">
                <div class="col-md-4">
                   <img class="stories-img" src="http://aquafind.com/images/pug.gif" alt="Happy Dog" >
                </div>
                <div class="col-md-8">
                    <h2> Spike </h2>
                    <p>
