...
<body>
    ...
    <div class="container">
        <div class="row pet-container">
            ...
            <div class="col-md-8 col-md-offset-1"> 
                ...
                <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">I Found This Pet!</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <p> We are connecting you with the person who lost their pet! Expect an email soon.</p>
        </div>
